...
public class MapGenerator {
       ...
       private static final int[][] isFull=new int[100][100]; /*0 for nothing,1 for floors and 2 for walls*/
       private static final List<Position> ListOfFloor=new ArrayList<>();
       private static final List<Position> FloorToBeAdded=new ArrayList<>();
